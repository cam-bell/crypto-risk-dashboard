...
class TestCoinGeckoClient:
    ...
    async def test_health_check(self, client):
        ...
        with patch.object(client, "_make_request") as mock_request:
            mock_response = APIResponse(
                success=True, data={"gecko_says": "V3 API is running"}
            )
    ...
    async def test_get_coin_price(self, client):
        ...
        with patch.object(client, "_make_request") as mock_request:
            mock_response = APIResponse(success=True, data={"bitcoin": {"usd": 50000}})
            mock_request.return_value = mock_response
    ...
    async def test_get_coin_detail(self, client):
        ...
        with patch.object(client, "_make_request") as mock_request:
            mock_response = APIResponse(
                success=True, data={"id": "bitcoin", "name": "Bitcoin", "symbol": "btc"}
            )
            mock_request.return_value = mock_response
...
class TestEtherscanClient:
    ...
    async def test_get_account_balance(self, client):
        ...
        with patch.object(client, "_make_request") as mock_request:
            mock_response = APIResponse(
                success=True, data={"status": "1", "result": "1000000000000000000"}
            )
            mock_request.return_value = mock_response
    ...
    async def test_get_account_transactions(self, client):
        ...
        with patch.object(client, "_make_request") as mock_request:
            mock_response = APIResponse(
                success=True, data={"status": "1", "result": []}
            )
            mock_request.return_value = mock_response
...
class TestAPIResponse:
    ...
    def test_error_response(self):
        ...
        response = APIResponse(
            success=False, error="API error occurred", status_code=500
        )
    ...
    def test_cached_response(self):
        ...
        response = APIResponse(success=True, data={"cached": "data"}, cached=True)
